...
public class ShadowMatrices {
	...
	public static float[] createOrthoMatrix(float halfPlaneLength, float shadowMapResolution) {
		return new float[]{
				// column 1
				...
				// column 3
				0f, 0f, 2.0f / (NEAR - shadowMapResolution), 0f,
				// column 4
				0f, 0f, -(shadowMapResolution + NEAR) / (shadowMapResolution - NEAR), 1f
		};
	}
	...
	private static final class Tests {
		public static void main(String[] args) {
			...
			test("ortho projection hpl=32", expected, createOrthoMatrix(32.0f, 256));
			...
			test("ortho projection hpl=110", expected110, createOrthoMatrix(110.0f, 256));
